...
class ticketController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tickets = $em->getRepository('cantineBundle:ticket')->findAll();
    ...
    {
        $ticket = new Ticket();
        $form = $this->createForm('cantineBundle\Form\ticketType', $ticket);
    ...
    {
        $deleteForm = $this->createDeleteForm($ticket);
        $editForm = $this->createForm('cantineBundle\Form\ticketType', $ticket);
